...
RANDOM_STATE = (
    4  # Note: Adjust this when assessing the influence of different random splits.
)
X_train, X_test, y_train, y_test = train_test_split(
    Am_array, Ci_all_array, test_size=0.2, random_state=RANDOM_STATE
)
...
my_df.to_csv(f"{FILENAME}_rs_{RANDOM_STATE}.csv", index=False)
