...
FILENAME = "20-20-2-asym-AB-AC"  # Note: Adjust this as needed.
...
data = {
    ...
    "A11": np.concatenate((X_train[:, 10], X_val[:, 10], X_test[:, 10])),
    "A12": np.concatenate((X_train[:, 11], X_val[:, 11], X_test[:, 11])),
    "A13": np.concatenate((X_train[:, 12], X_val[:, 12], X_test[:, 12])),
    "A14": np.concatenate((X_train[:, 13], X_val[:, 13], X_test[:, 13])),
    "A15": np.concatenate((X_train[:, 14], X_val[:, 14], X_test[:, 14])),
    "A16": np.concatenate((X_train[:, 15], X_val[:, 15], X_test[:, 15])),
    "A17": np.concatenate((X_train[:, 16], X_val[:, 16], X_test[:, 16])),
    "A18": np.concatenate((X_train[:, 17], X_val[:, 17], X_test[:, 17])),
    "A19": np.concatenate((X_train[:, 18], X_val[:, 18], X_test[:, 18])),
    "A20": np.concatenate((X_train[:, 19], X_val[:, 19], X_test[:, 19])),
...
my_df.to_csv(
    f"{FILENAME}_grouped_C2_high.csv", index=False
